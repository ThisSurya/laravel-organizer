...
class PostingController extends Controller
{
    ...
    public function index($id) : View|RedirectResponse
    {
        ...
        $group = Proker::findOrFail($id)->users()->wherePivot('user_id', $sessionId)->get();
        ...
        $member = $this->memberManagementServices->getMember($id);
    ...
    public function editView(Request $request) : View|RedirectResponse
    {
